...
public final class Constant {
    ...
    public static final SimpleColor WINDOW_BACKGROUND_COLOR = SimpleColor.sRGB("#000F1B");
    ...
    public static final SimpleColor PROGRESS_BAR_FILL_EMPTY_COLOR = BUTTON_COLOR.duplicate().multiply(0.85)
        .add(BLACK.duplicate().multiply(0.15));
    public static final SimpleColor PROGRESS_BAR_FILL_COLOR = BUTTON_HIGHLIGHT_COLOR;
    public static final SimpleColor PROGRESS_BAR_FILL_HIGHLIGHT_COLOR = BUTTON_HIGHLIGHT_COLOR.duplicate().multiply(0.75)
        .add(WHITE.duplicate().multiply(0.25));
